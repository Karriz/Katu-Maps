...
type MobileSheetHandleWithCloseProps = MobileSheetHandleProps & {
  closeLabel: string;
  onClose: () => void;
};

export function MobileSheetHandle({ closeLabel, handleProps, onClose, setSnap, snap }: MobileSheetHandleWithCloseProps) {
  return (
