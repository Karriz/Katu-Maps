...
export const FLIGHT_AIRCRAFT_SCALE = 2 / 3;
const FLIGHT_SPEED_SCALE = 2 / 3;
export const FLIGHT_CRUISE_SPEED_METERS_PER_SECOND = 110 * FLIGHT_SPEED_SCALE;
export const FLIGHT_STALL_SPEED_METERS_PER_SECOND = 42 * FLIGHT_SPEED_SCALE;
export const FLIGHT_MAX_SPEED_METERS_PER_SECOND = 160 * FLIGHT_SPEED_SCALE;
export const FLIGHT_MIN_SPEED_METERS_PER_SECOND = 18 * FLIGHT_SPEED_SCALE;
/** Distance from the aircraft model origin down to the skid contact plane. */
export const FLIGHT_SKID_CONTACT_OFFSET_METERS = 1.65 * FLIGHT_AIRCRAFT_SCALE;
