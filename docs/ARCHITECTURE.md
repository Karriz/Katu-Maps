...
- Fintraffic Digitraffic road weather stations and traffic measurement data
  for optional driving layers.
...
- `RoadTrafficLayer.ts` shows TMS traffic as coloured road segments.
